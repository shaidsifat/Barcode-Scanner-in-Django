...
class ProductDetails(models.Model):
    ...
    product_type = models.CharField(max_length=24,blank=True, null=True) 
    product_unit = models.CharField(max_length=34,blank=True,null=True)
    stock =   models.CharField(max_length=20000,blank=True, null=True) 
